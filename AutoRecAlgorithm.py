# -*- coding: utf-8 -*-
"""
Created on Wed Jun  3 22:04:23 2020
...
class AutoRecAlgorithm(AlgoBase):
    ...
    def fit(self, trainset):
        ...
        autoRec = AutoRec(trainingMatrix.shape[1], hiddenDimensions = self.hiddenDim, learningRate = self.learningRate, batchSize = self.batchSize)
